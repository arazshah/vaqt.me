...
**آخرین به‌روزرسانی:** فاز ۶ — پیشنهادها (Offers)؛ بک‌اند + UI کامل شد
**وضعیت:** فاز ۵ (درخواست‌ها) عملاً کامل؛ فاز ۶ (پیشنهادها) بک‌اند و UI اصلی
هر دو تکمیل — UI ارسال مجدد بعد از پس‌گیری باقی مانده
...
| ۶ — پیشنهادها      | 🔄 در حال انجام | بک‌اند + UI کامل (ثبت/لیست/انتخاب/پس‌گیری)؛ UI ارسال مجدد بعد از پس‌گیری ساخته نشده                |
