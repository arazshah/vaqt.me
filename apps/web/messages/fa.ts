...
export const fa = {
  ...
  homePage: {
    ...
    ctaBrowse: 'مشاهده‌ی درخواست‌ها',
    ctaLoginOrStart: 'ورود و شروع',
    ctaNewRequest: 'ثبت درخواست جدید',
    feature1Title: 'درخواستتان را بگذارید',
    feature1Description:
      'هر کاری که به دقایقی از وقت یک متخصص نیاز دارد را با جزئیات ثبت کنید — آنلاین یا حضوری.',
    feature2Title: 'از افراد واقعی پیشنهاد بگیرید',
    feature2Description:
      'ارائه‌دهنده‌ها زمان، مدت و قیمت پیشنهادی‌شان را می‌فرستند؛ شما انتخاب می‌کنید.',
    feature3Title: 'گفتگو و پرداخت امن',
    feature3Description:
      'پس از انتخاب پیشنهاد، یک گفتگوی مستقیم باز می‌شود و پرداخت از همان‌جا انجام می‌شود.',
  },
  requestStatus: {
    DRAFT: 'پیش‌نویس',
    PUBLISHED: 'منتشرشده',
  ...
  requestsPage: {
    ...
    noResultsDescription: 'فیلترها را تغییر دهید یا آن‌ها را پاک کنید.',
    ...
    filters: {
      searchPlaceholder: 'جست‌وجو در عنوان و توضیحات…',
      categoryAll: 'همه‌ی دسته‌ها',
      modeAll: 'همه‌ی حالت‌ها',
      cityPlaceholder: 'شهر',
  ...
  newRequestPage: {
    ...
    subtitle: 'جزئیات کارتان را وارد کنید تا ارائه‌دهنده‌ها پیشنهاد بدهند.',
    sections: {
      basics: 'اطلاعات پایه',
      logistics: 'جزئیات همکاری',
      budget: 'بودجه',
      timing: 'زمان‌بندی',
    },
    fields: {
  ...
  aiWizardPage: {
    ...
    subtitle: 'کارتان را توضیح دهید، جزئیات را با هم جمع می‌کنیم.',
    intro:
